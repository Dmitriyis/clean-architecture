package com.course.cleanarchitecture.core.domain.appointment.presentation;

import com.course.cleanarchitecture.core.domain.appointment.application.useCase.CreateNewAppointmentUseCase;
import com.course.cleanarchitecture.core.domain.appointment.application.useCase.DeleteAppointmentByIdUseCase;
import com.course.cleanarchitecture.core.domain.appointment.application.useCase.GetAppointmentByIdUseCase;
import com.course.cleanarchitecture.core.domain.appointment.application.useCase.UpdateAppointmentUseCase;
import com.course.cleanarchitecture.core.domain.appointment.application.useCase.dto.AppointmentRequestDto;
import com.course.cleanarchitecture.core.domain.appointment.application.useCase.dto.AppointmentResponseDto;
import com.course.cleanarchitecture.core.domain.appointment.application.useCase.dto.AppointmentUpdateDto;
