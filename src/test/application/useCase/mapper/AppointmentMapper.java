package com.course.cleanarchitecture.core.domain.appointment.application.useCase.mapper;

import com.course.cleanarchitecture.core.domain.appointment.infrastructure.adapter.database.repository.AppointmentSearchParamsSpecification;
...
public class AppointmentMapper {
    ...
    public AppointmentEntity toAppointmentEntity(AppointmentRequestDto appointmentRequestDto, UUID id) {
        return GenerateAppointment.generate(id, appointmentRequestDto.getPetId(), appointmentRequestDto.getDoctorId());
    }
