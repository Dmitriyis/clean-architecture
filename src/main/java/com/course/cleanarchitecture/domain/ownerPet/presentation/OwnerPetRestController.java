package com.course.cleanarchitecture.domain.ownerPet.presentation;

import com.course.cleanarchitecture.domain.ownerPet.model.OwnerPetEntity;
import com.course.cleanarchitecture.domain.ownerPet.application.useCase.CreateNewOwnerPetUseCase;
import com.course.cleanarchitecture.domain.ownerPet.application.useCase.DeleteOwnerPetByIdUseCase;
import com.course.cleanarchitecture.domain.ownerPet.application.useCase.FindAllOwnerPetBySearchParamsUseCase;
import com.course.cleanarchitecture.domain.ownerPet.application.useCase.GetOwnerPetByIdUseCase;
import com.course.cleanarchitecture.domain.ownerPet.application.useCase.UpdateOwnerPetUseCase;
